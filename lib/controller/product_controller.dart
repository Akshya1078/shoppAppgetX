...
class ProductController extends GetxController{
 ...
 final List<Product>_items=[
   Product(
      ...
      price: 7000.00,
      imageUrl:
      'https://images-eu.ssl-images-amazon.com/images/I/71RlOgFT-wL._AC._SR360,460.jpg',
    ),
    Product(
        id: 2,
        productTitle: 'Legend',
    ...
    Product(
        ...
        price: 49.00,
        imageUrl:
        'https://media.kohlsimg.com/is/image/kohls/4501913_Taupe?wid=600&hei=600&op_sharpen=1'),
  Product(
        id: 4,
   ...
   Product(
        ...
        price: 49.99,
        imageUrl:
        'https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcT85WmbX6YYZJ4EIjiVdmhyufav9wIYevHgHQ&usqp=CAU'),
    Product(
        id: 10,
        productTitle: 'Men\'s Sneakers',
        description: 'Clean & Comfortable Sneakers made with classic Leathers.',
  ...
  Product finalProductById(int id){
    return _items.firstWhere((element) => element.id==id);
  }

  void togglFavouriteStatus(int id){
